...
export function ChartAreaInteractive() {
  ...
  const chartConfig = {
    visitors: {
      label: t("dashboard.apiInferences"),
    },
    desktop: {
      label: t("dashboard.deepThink"),
      color: "var(--primary)",
    },
    mobile: {
      label: t("dashboard.quickThink"),
      color: "var(--chart-3)",
    },
  ...
  return (
    <Card className="@container/card bg-card/60 backdrop-blur-xl border-primary/20 hover:shadow-[0_0_20px_rgba(var(--primary),0.05)] transition-all duration-300">
      <CardHeader>
        <CardTitle>{t("dashboard.processingVolume")}</CardTitle>
        <CardDescription>
          <span className="hidden @[540px]/card:block">
            {t("dashboard.inferenceOverTime")}
          </span>
